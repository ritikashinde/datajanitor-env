...
"""
First Rldemo Environment Implementation.
...
class FirstRldemoEnvironment(Environment):
    ...
    Example:
        ...
        >>> obs = env.reset()
        >>> print(obs.echoed_message)  # "First Rldemo environment ready!"
        >>>
    ...
    def __init__(self):
        """Initialize the first_rldemo environment."""
    ...
    def reset(self) -> FirstRldemoObservation:
        ...
        return FirstRldemoObservation(
            echoed_message="First Rldemo environment ready!",
            message_length=0,
            done=False,
            reward=0.0,
        )
